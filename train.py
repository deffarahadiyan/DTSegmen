...
EPOCHS = 500 #semakin tinggi semakin bagus, tapi hindari overfit
INIT_LR = 1e-3 # e=2,7xxx , jangan terlalu kecil nnti respon lambat. kalo terlalu besar, tidak akurat
BS = 10  #misal dataset ada 50, maka 5 ditrain terus 5 lagi terus 5lg
IMAGE_DIMS = (96, 96, 3)
...
H = model.fit(x=trainX,
	y={"category_output": trainCategoryY, "state deficiency_output": trainColorY},
	validation_data=(testX,
		{"category_output": testCategoryY, "state deficiency_output": testColorY}),
	epochs=EPOCHS,
	verbose=1)
